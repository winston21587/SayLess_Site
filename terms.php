...
<head>
    ...
    <title>Terms of Service - SayLess</title>
...
<body class="antialiased bg-black text-white selection:bg-accent selection:text-white relative overflow-x-hidden">
    ...
    <!-- Background Elements -->
    <div
        class="fixed top-0 right-1/2 translate-x-1/2 w-[800px] h-[500px] bg-accent/10 rounded-full blur-[120px] -z-10 pointer-events-none">
    </div>
    <div
        class="fixed bottom-0 left-0 w-[600px] h-[600px] bg-purple-900/10 rounded-full blur-[100px] -z-10 pointer-events-none">
    </div>
                ...
                <div class="sticky top-32 space-y-8">
                    <div>
                        ...
                        <nav class="flex flex-col gap-3 text-sm border-l border-white/10 pl-4">
                            <a href="#agreement"
                                class="text-white font-medium border-l-2 border-accent -ml-[17px] pl-4 transition-all">Agreement</a>
                            <a href="#ip" class="text-secondary hover:text-white transition-colors">Intellectual
                                Property</a>
                            <a href="#user-reps" class="text-secondary hover:text-white transition-colors">User
                                Representations</a>
                            <a href="#liability" class="text-secondary hover:text-white transition-colors">Liability</a>
            ...
            <div class="space-y-12">
                ...
                <div class="mb-16">
                    ...
                    <h1 class="text-5xl md:text-7xl font-bold tracking-tight mb-6">
                        Terms of <br /><span class="text-gradient">Service</span>
                    </h1>
                    <p class="text-lg text-secondary leading-relaxed max-w-2xl">
                        Please read these terms carefully before using our services. They govern your relationship with
                        SayLess and outline our mutual obligations.
                    </p>
                </div>
                ...
                <div class="space-y-8">
                    ...
                    <section id="agreement"
                        ...
                        <p class="text-secondary leading-relaxed">
                            ...
                            personally or on behalf of an entity ("you") and SayLess ("we," "us," or "our"). By
                            accessing the Site, you agree that you have read, understood, and agreed to be bound by all
                    ...
                    <section id="ip"
                        ...
                        <p class="text-secondary leading-relaxed mb-4">
                            ...
                            (collectively, the "Content") are owned or controlled by us or licensed to us, and are
                    ...
                    <section id="user-reps"
                        ...
                        <div class="grid md:grid-cols-2 gap-4">
                            <div
                                class="bg-black/20 p-4 rounded-lg border border-white/5 hover:border-accent/20 transition-colors">
                                <span class="text-accent text-lg font-bold block mb-2">01</span>
                                <p class="text-sm text-secondary">All registration information you submit will be true,
                                    accurate, current, and complete.</p>
                            </div>
                            <div
                                class="bg-black/20 p-4 rounded-lg border border-white/5 hover:border-accent/20 transition-colors">
                                <span class="text-accent text-lg font-bold block mb-2">02</span>
                                <p class="text-sm text-secondary">You will maintain the accuracy of such information and
                                    promptly update it as necessary.</p>
                            </div>
                        </div>
                    </section>
                    ...
                    <section id="contact"
                        ...
                        <h2 class="text-2xl font-bold text-white mb-4">Questions about our terms?</h2>
                        <p class="text-secondary leading-relaxed mb-6">
                            If you have any questions or feedback regarding these terms, please don't hesitate to reach
                            out.
                        </p>
        ...
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="border-t border-white/5 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
                ...
                <div class="flex gap-6 text-xs text-secondary">
                    ...
                    <a href="terms.php" class="group relative text-white transition-colors duration-300">
                        Terms of Service
                        <span
